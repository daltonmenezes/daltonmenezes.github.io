...
blog.addEventListener('mouseover', function() {
  topQuotes.style.animation = 'quote-start-transition 0.8s ease';
  bottomQuotes.style.animation = 'quote-start-transition 0.8s ease';
...
blog.addEventListener('mouseout', function() {
  topQuotes.style.animation = 'quote-finish-transition 0.8s ease';
  bottomQuotes.style.animation = 'quote-finish-transition 0.8s ease';
